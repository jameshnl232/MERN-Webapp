...
export default function PostCard({post}: Props) {
   return (
     <div className='group relative h-[400px] w-full overflow-hidden rounded-lg border dark:text-gray-100 border-sky-500 transition-all hover:border-2 sm:w-[430px]'>
